...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'frontend_build', 'static'),  # React build static files
]
...
# Optional: WhiteNoise compression and caching
...
# Optional but recommended for WhiteNoise compression and caching
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'
